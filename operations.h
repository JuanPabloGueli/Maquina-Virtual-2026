...
#define ARCH_NAME_SIZE 30 // cantidad de caracteres que componen el nombre del arch.vmx o arch.vmi
...
#define CANT_SEG 8 // cantidad de segmentos
...
typedef struct maquinaV{ 
    ...
    unsigned short int tablaSeg[CANT_SEG][2]; // tabla de segmentos: matriz de 8x2, una fila x segmento
    int error;
